// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:44:0
...
// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:52:25
        printState(_id__c, "Atom1", "A", "B", "");

// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:52:1
        if (! fromA()) {
...
// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:53:25
        printState(_id__c, "Atom1", "A", "C", "");

// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:53:1
        if (! fromA()) {
            NonOneSafePetriNetError *r = new NonOneSafePetriNetError(*this);
            r->setPort(_iport_decl__AtoC);
            return *r;
...
// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:54:25
        printState(_id__c, "Atom1", "A", "C", "");

// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:54:1
        if (! fromC()) {
            NonOneSafePetriNetError *r = new NonOneSafePetriNetError(*this);
            r->setPort(_iport_decl__CtoB);
            return *r;
...
// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:55:25
        printState(_id__c, "Atom1", "B", "A", "");

// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:55:1
        if (! fromB()) {
            NonOneSafePetriNetError *r = new NonOneSafePetriNetError(*this);
            r->setPort(_iport_decl__BtoA);
            return *r;
...
BipError& AT_check_Atom1::initialize() {
    ...
    // initial action
// /home/dsg003/Dropbox/eclipse_workspace/Text2BIP/bip_sample/check.bip:51:19
    printState(_id__c, "Atom1", "initial", "A", "");
